export default {
    ...
    EMAIL_CANCELLED_ORDER:
        'Your order has been cancelled, this are the details: ',
    ORDER_NOTIFICATION_CANCELLATION_TITLE: 'Cancelled order: ',
    ORDER_NOTIFICATION_TITLE: 'New order: ',
    ORDER_NOTIFICATION_CLIENT_TITLE: 'Order: ',
    ORDER_NOTIFICATION_CONTACT_INFORMATION: 'Contact Information',
    ORDER_NOTIFICATION_CONTACT_INFORMATION_FIRST_NAME: 'Name',
    ORDER_NOTIFICATION_CONTACT_INFORMATION_LAST_NAME: 'Last name',
    ORDER_NOTIFICATION_CONTACT_INFORMATION_EMAIL: 'Email',
    ORDER_NOTIFICATION_CONTACT_INFORMATION_PHONE: 'Phone',
    ORDER_NOTIFICATION_SHIPPING_ADDRESS_TITLE: 'Shipping Address',
    ORDER_NOTIFICATION_SHIPPING_ADDRESS: 'Address',
    ORDER_NOTIFICATION_SHIPPING_CITY: 'City',
    ORDER_NOTIFICATION_SHIPPING_PROVINCE: 'Province',
    ORDER_NOTIFICATION_SHIPPING_DELIVERY_INSTRUCTIONS: 'Delivery Instructions',
    ORDER_NOTIFICATION_PICKUP_LOCATION_TITLE: 'Pickup Location',
    ORDER_NOTIFICATION_PICKUP_LOCATION_NAME: 'Name',
    ORDER_NOTIFICATION_PICKUP_LOCATION_ADDITIONAL_DETAILS: 'Additional Details',
    ORDER_NOTIFICATION_PAYMENT_METHOD: 'Payment Method',
    ORDER_NOTIFICATION_PAYMENT_METHOD_PAYMENT_INSTRUCTIONS: 'Instructions',
